...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($category_id <= 0) die("Please select a valid category.");
    ...
    if (isset($_FILES['image']['name']) && $_FILES['image']['error'] === 0) {
        ...
        else die("Failed to upload image.");
    }
...
.sidebar{width:250px;background:#111;color:#fff;transition:0.3s;overflow:hidden;}
...
.product-form button{margin-top:20px;padding:12px 20px;background:#007bff;color:#fff;border:none;border-radius:5px;cursor:pointer;transition:0.2s;}
.product-form button:hover{background:#0056b3;}
...
<div class="dashboard">
    ...
    <aside class="sidebar" id="sidebar">
        <h2>🚗 CarStore</h2>
        <ul>
            <li><a href="../hmtm/dashboard.php"><i class="fa fa-home"></i> <span>لوحة التحكم</span></a></li>
