...
.btn{padding:6px 12px;border:none;border-radius:5px;color:#fff;cursor:pointer;text-decoration:none;transition:0.2s;font-size:14px;}
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                  ...
                  <img src="../../uploads/<?= $row['image_url'] ?>" alt="product">
                    <?php endif; ?>
                </td>
                <td>
